...
myFooter = myFooter + "		</div>";
myFooter = myFooter + "		<div>";
myFooter = myFooter + "			<a href=”callto:+39 0774367075”><i class='fa fa-phone'></i></a>";
myFooter = myFooter + "			<p> <a href=”callto:+39 0774367075”>+39 0774367075</a></p>";
myFooter = myFooter + "		</div>";
myFooter = myFooter + "		<div>";
...
myFooter = myFooter + "			<span>About the company</span>";
myFooter = myFooter + "			Lorem ipsum dolor sit amet, consectateur adispicing elit. Fusce euismod convallis velit, eu auctor lacus vehicula sit amet.";
myFooter = myFooter + "		</p>";
