		...
		<DIV class="container-fluid">
			...
			<DIV class="row TopData">
				...
				if ($action == 'InsBenefici') {
					...
					$SQL .= "'" . convert_smart_quotes($_POST["ben_name"]) . "',  ";

					$SQL .= "'" . convert_smart_quotes($_POST["ben_desc"]) . "')";
				...
				if ($action == 'UpdBenefici') {
					...
					$SQL .= " `Ben_Prop` = '" . convert_smart_quotes($_POST["upd_ben_name"]) . "',  ";

					$SQL .= " `Descrizione` = '" . convert_smart_quotes($_POST["upd_ben_desc"]) . "'   ";
				...
				if ($action == 'InsProprieta') {
					...
					$SQL .= "'" . convert_smart_quotes($_POST["prop_name"]) . "',  ";

					$SQL .= "'" . convert_smart_quotes($_POST["prop_desc"]) . "')";
