...
myFooter = myFooter + "			<a href='lineeGuida.html'>Linee Guida</a>";
myFooter = myFooter + "	        <a href='#myModal' data-toggle='modal' >Contattaci</a>";
myFooter = myFooter + "		</p>";
myFooter = myFooter + "		<p class='footer-company-name'>Biovita Life © 2023</p>";
...
myFooter = myFooter + "			<p><a href='mailto:info@biovitalife.it'>info@biovitalife.it</a></p>";
myFooter = myFooter + "		</div>";
myFooter = myFooter + "	</div>";
