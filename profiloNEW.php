...
<form name="frmProfilo" method="post" action="#" OnOpenForm="OnOpenForm()">
    ...
    $actUpd1 = $_REQUEST["act_upd"];
    $actUpd2 = $_GET["act_upd"];
    ...
    if ($actUpd == 'AggiornaPersona') {
        ...
        echo "<br>nome: [" . $nuovoNome . "]";
        echo "<br>cognome: [" . $nuovoCognome . "]";
        echo "<br>codice fiscale: [" . $nuovoCodiceFiscale . "]";
        echo "<br>data di nascita: [" . $nuovoDataDiNascita . "]";
        echo "<br>sesso: [" . $nuovoSesso . "]";
        echo "<br>luogo di nascita: [" . $nuovoLuogoDiNascita . "]";
        echo "<br>id tipo persona: [" . $IDTipoPersona . "]";
                        ...
                        <div class="card mb-3 gx-3">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="avatar-wrapper">
                                    ...
                                    <input class="file-upload" id="avatar" type="file" accept="image/*" />
                                </div>
                                <!-- Profile picture help block-->
                                <div class="small font-italic text-muted "> <button type="submit" class="btn-sm"
                                        name="submit">Carica</button>
                                </div>
                                ...
                                <div class="card-body gx-4 ">
                                    ...
                                    <div class="mb-3 gx-3 mt-5">
                                        <button class="btn btn-success gx-3" id="btn_persona"
                                            onClick="AggiornaProfilo('AggiornaPersona')">Salva
                                            Modifiche</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body gx-4 ">
                                        ...
                                        <div class="mb-3 gx-3 mt-5">
                                            <button class="btn btn-success gx-3" id="btn_azienda"
                                                onClick="AggiornaProfilo('AggiornaImpresa')">Salva
                                                Modifiche</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="grid-item-full">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="denominazione"
                                                name="denominazione" placeholder="Inserisci il nominativo" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 ml-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cap" id="cap"
                                                placeholder="CAP" required maxlength="5" pattern="[0-9]{5}">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 ml-4">
                                        <div class="form-group">
